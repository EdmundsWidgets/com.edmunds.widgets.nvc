 ...
 EDM.namespace('nvc').RadioGroup = (function() {
    ...
    RadioGroup.prototype = {
        ...
        render: function (){
            ...
            templateElement.className = 'option-group color-group';
        ...
        renderList: function(){
            ...
            _listEl     = this.listEl = getElementsByClassName('list', '', _groopEl)[0];
            ...
            for (i = 0; i < _length; i = i + 1) {
                ...
                _item.className = 'features-list-item color';
                _item.innerHTML = [
                    '<label for="for' + list[i].id + '">',
                        ...
                        '<span class="feature-price">' + priceHtml + '</span>',
                        '<span class="feature-name">' + list[i].name + '</span>',
                    '</label>'
                    /*
        ...
        template: [
            ...
            '<div class="option colors-category" id="<%= baseId %>_colors_<%= group %>">',
                '<div class="head"><span class="price">$0</span><span class="pic default"><span class="secondary"></span></span><span class="value">Select a Color</span><span class="value alt"><%= group %> Color</span></div>',
                '<div class="option-wrap">',
                    '<div class="list features-list"></div>',
                    '<div class="foot"><button type="button" class="button-small button-light">Close</button></div>',
                '</div>',
            '</div>'
        ].join('')

    ...
    VehicleDealers.prototype = {
        ...
        loadDealers: function(root, options) {
            var successCallback = bind(this.onDealersLoad, this),
                ...
                invalidTiers = options.invalidTiers;
            ...
            this.dealersChoiced = {};
            this.vehicleApi.getDealersList(makeName, model, styleid, zipcode, radius, rows, isPublic, bookName, keywords, premierOnly, invalidTiers, successCallback, errorCallback);
        },
        ...
        onDealersLoad: function(response) {
            ...
            var dealers = this.parseDealers(response).sort(function(dealer1, dealer2) {
                return parseFloat(dealer1.distance) - parseFloat(dealer2.distance);
            });
            ...
            if (dealersList){
                ...
                for (i = 0; i < length; i = i + 1) {
                    ...
                    dealers.push({
                        ...
                        phone:      item.displayinfo.dealer_trackable_phone,
